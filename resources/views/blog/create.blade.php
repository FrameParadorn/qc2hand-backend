        ...
        <div class="col-sm-12">
            <div class="white-box">
              ...
              <div class="clearfix"></div>
							<form method="POST" action="/blog" enctype="multipart/form-data" class="form-blog">
                @csrf
                  ...
                  Save 
								...
								<div class="form-row">
										...
										<div class="col-md-12 mb-3" style="margin-top: 15px">
												...
												<input type="file" name="cover" class="form-control" placeholder="First name" required>
										</div>
										<div class="col-md-12 mb-3" style="margin-top: 15px">
                        ...
                        <br>
                        <textarea id="editor_web" name="content_web" cols="80" rows="10">
                        </textarea>
										</div>
                        ...
                        <br>
                        <textarea id="editor_mobile" name="content_mobile" cols="80" rows="20">
                        </textarea>
										</div>
